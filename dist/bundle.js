...
var baseUrl = "https://studinapifinal.azurewebsites.net/api/";
...
new Vue({
    ...
    methods: {
        ...
        GetTeacher: function () {
            var _this = this;
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl + "teacher", this.sendData)
        ...
        AddUserLesson: function (student) {
            var _this = this;
            var userlesson = { id: 1, fkusers: student.id, fklessons: this.userTeacher.currentCourse.lessonId, checkedout: false, minutesStayed: 0, minutesLate: 0 };
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl + "userlesson", userlesson)
                .then(function (response) {
        ...
        DeleteUserLesson: function (deleteId) {
            var _this = this;
            var uri = baseUrl + "userlesson/" + deleteId;
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.delete(uri)
                ...
                .catch(function (error) {
                _this.deleteMessage = error.message;
                alert(error.message);
            });
        }
    },
